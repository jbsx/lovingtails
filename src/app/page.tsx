  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="w-full my-[20vh] flex justify-center items-center p-5">
        ...
        />
        <p
          className="w-[800px] md:w-fit text-3xl leading-loose border-l-4 border-[var(--accent-clr1)] p-[1em] 
      ...
      <div className="w-full flex flex-col justify-center items-center py-[12em] text-[var(--accent-clr2)]">
        ...
        <Link
          href={"/store"}
          className="bg-[var(--accent-clr2)] px-[2em] py-[1em] hover:bg-[var(--accent-clr1)] text-white w-fit font-semibold"
        >
          Visit Store
        </Link>
      </div>

      <div className="my-[5em] text-xl text-justify bg-[var(--accent-clr2)] max-w-[1200px] relative py-[2em] z-[-2] text-white font-medium">
        <div className="text-2xl leading-loose p-[2em] text-center sm:p-[0.5em] sm:text-xl">
          <div className="absolute top-0 left-0 w-full h-full bg-[url(../../public/bowl.png)] bg-origin-content bg-[length:60px_40px] z-[-1] opacity-[10%]"></div>
